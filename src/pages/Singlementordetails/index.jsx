              ...
              <Column className="justify-start lg:mt-[21px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] pr-[2px] py-[2px] w-[95%]">
                <Column className="justify-start w-[95%]">
                  ...
                  <Text className="description6" variant="body5">
                    I have been a software developer with the principle to create anything you can imagine so I created this site with react for you to 💕 and 👩‍🏫. MADE WITH 💖
                    <br />
                    <br />
                    I love you and want to thank you for using this site it might not be fine or dynamic at the start but this is just something I wanted to put out there so if you have better Ideas or skills contact me: andrespedrionyerikam@gmail.com
                  </Text>
                </Column>
                <Column className="justify-start mb-[2px] lg:mt-[27px] xl:mt-[33px] 2xl:mt-[38px] 3xl:mt-[45px] w-[95%]">
                  ...
                  <Text className="description6" variant="body5">
                    Web dev, App dev, Educator, Forex Trader, Microsoft Software Engineering
                  </Text>
                </Column>
              </Column>
            </Column>
